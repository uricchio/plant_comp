...
class Comp:
    ...
    def write_params(self,spec,init=False):
        ...
        for thing in self.al[spec]:
            ...
            i += 1
        ll0 = self.ll_t(spec,self.p0,self.r0,self.al[spec])
        outh.write(str(ll0)+'\n')
    ...
    def burn_in(self,spec):
        ...
        ll_cur = self.ll_t(spec,self.p0,self.r0,self.al[spec])
        ...
        while nSamps < self.burn: 
            ...
            ll_next = self.ll_t(spec,pt,rt,alt)
            ...
            if nSamps > 1 and nSamps % 200 == 0:
                ...
                print ll_cur, ll_next, np.divide(self.al[spec],self.rescale_rat), self.p0, self.r0, self.rsd, self.psd, self.alsd
